...
class SwinUnet(BaseModule):
    def __init__(self, img_size=224, num_classes=21843, zero_head=False,
                 vis=False,drop_path_rate=0.2,load_pretrain_path=None,ape=False):
    ...
    def load_from(self):
        pretrained_path = self.load_pretrain_path
        if pretrained_path is not None:
            ...
            if "model" not in pretrained_dict:
                ...
                pretrained_dict = {k[17:]: v for k, v in
